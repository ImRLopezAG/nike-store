...
export const AppleIcon: React.FC<Props> = ({ className }) => (
...
export const PaypalIcon: React.FC<Props> = ({ className }) => (
...
export const CreditCardIcon: React.FC<Props> = ({ className }) => (
...
export const HalfStarIcon: React.FC<Props> = ({ className }) => (
...
export const TagIcon: React.FC<Props> = ({ className }) => (
...
export const PlusIcon: React.FC<Props> = ({ className }) => (
  <svg className={cn('size-6', className)} width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0" /><path d="M9 12h6" /><path d="M12 9v6" /></svg>
)

export const MinusIcon: React.FC<Props> = ({ className }) => (
  <svg className={cn('size-6', className)} width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round" ><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M9 12l6 0" /></svg>
)

export const CloseIcon: React.FC<Props> = ({ className }) => (
  <svg  className={cn('size-6', className)}  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M18 6l-12 12" /><path d="M6 6l12 12" /></svg>
)

export const InvoiceIcon: React.FC<Props> = ({ className }) => (
